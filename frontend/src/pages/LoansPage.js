              ...
              <form onSubmit={handleApply} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-blue-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-300"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg transition-all focus:outline-none focus:ring-2 focus:ring-green-300"
                >
                  Submit Application
                </button>
              </form>
